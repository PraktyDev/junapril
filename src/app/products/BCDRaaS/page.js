  ...
  return (
    <div className='flex flex-col mb-40'>
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Identification of key business functions and potential risks</li>
                        <li className='pl-4'>Analysis of the impact of disruptions on your operations</li>
                        <li className='pl-4'>Prioritization of recovery processes based on business requirements</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Customized business continuity strategies</li>
                        <li className='pl-4'>Crisis communication and management protocols</li>
                        <li className='pl-4'>Resource allocation and contingency planning</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Data backup and recovery solutions</li>
                        <li className='pl-4'>Strategies for system and application restoration</li>
                        <li className='pl-4'>Testing and validation of recovery processes</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Automated, encrypted data backups</li>
                        <li className='pl-4'>Rapid data restoration from the cloud</li>
                        <li className='pl-4'>Geographic redundancy to ensure data availability</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Routine testing and simulations of recovery plans</li>
                        <li className='pl-4'>Monitoring of backup and recovery systems</li>
                        <li className='pl-4'>Continuous updates to align with new threats and business changes</li>
                    </ul> 
                </div>
            </span>
            ...
            <ul className='flex flex-col list-disc list-outside pl-8 -mt-4'>
                <li><span className='font-semibold'>Minimized Downtime:</span> Our rapid recovery solutions ensure that your business operations are back up and running in record time.</li>
                <li><span className='font-semibold'>Data Security:</span> We use advanced encryption and security measures to protect your data from loss or unauthorized access.</li>
                <li><span className='font-semibold'>Regulatory Compliance:</span> We help you meet industry-specific compliance requirements, including data protection and security standards.</li>
                <li><span className='font-semibold'>Peace of Mind:</span> With a solid BCDR plan in place, you can focus on running your business without worrying about unforeseen disruptions.</li>
            </ul>
            
            <p className='font-semibold'>Ready to Safeguard Your Business?</p>
            
            <p className='-mt-4'>Don't leave your business's future to chance. Partner with Junapril Solutions Ltd to implement a reliable Business Continuity and Disaster Recovery strategy. Contact us today to learn more about our BCDR as a Service and discover how we can protect your business from the unexpected.</p>
        </div>
    </div>
  )
}
