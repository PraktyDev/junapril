  ...
  return (
    <div className='flex flex-col mb-40'>
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Custom IT governance framework and policies</li>
                        <li className='pl-4'>Governance models for decision-making and accountability</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Performance metrics and dashboards for real-time insights</li>
                        <li className='pl-4'>Regular governance reports and strategic recommendations</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Well-defined IT policies and procedures</li>
                        <li className='pl-4'>Policy implementation and monitoring strategies</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Step-by-step user instructions with visuals and diagrams</li>
                        <li className='pl-4'>Training guides tailored to your organization’s needs</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Comprehensive system documentation</li>
                        <li className='pl-4'>Diagrams and flowcharts for easy understanding</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>In-depth white papers for thought leadership</li>
                        <li className='pl-4'>Technical reports that communicate complex concepts clearly</li>
                    </ul>
                </div>
            ...
            <p className='-mt-4'>Whether you need to establish strong IT governance practices or require expertly crafted technical content, Junapril Solutions Ltd is here to help. Contact us today to learn more about our services and how we can support your business success.</p>
        </div>
    </div>
  )
}
