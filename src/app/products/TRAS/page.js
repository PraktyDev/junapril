...
const page = () => {
  return (
    <div className='flex flex-col'>
        <ProductHeader src="bg-[url('/images/homehero.png')]" title='Threat Risk Assessment (TRA) Services' />
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <div className="py-4"><Image className="w-full h-[500px] rounded-3xl object-cover" src='/images/tras.png' alt="" width={1000} height={1000} /></div>
