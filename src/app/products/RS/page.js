...
const page = () => {
  return (
    <div className='flex flex-col'>
        <ProductHeader src="bg-[url('/images/homehero.png')]" title='Recruitment Solutions' />
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Comprehensive analysis of your hiring needs and goals</li>
                        <li className=''>Actionable recruitment strategies tailored to your industry</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Multi-channel job advertising campaigns designed to maximize visibility</li>
                        <li className=''>Access to a wide network of potential candidates, including passive job seekers</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Pre-screening of candidates based on your specific criteria</li>
                        <li className=''>Skills assessments and personality tests to gauge candidate fit</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Coordination of interviews between candidates and your team</li>
                        <li className=''>Best practice guidance for conducting effective interviews</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Assistance with crafting competitive job offers</li>
                        <li className=''>Resources and guidance for effective onboarding processes</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Insights into recruitment performance, including time-to-fill and candidate quality</li>
                        <li className=''>Recommendations for optimizing your recruitment processes based on data analysis</li>
                    </ul>
                </div>
            ...
            <ul className='flex flex-col space-y-2 list-disc list-inside'>
                <li>Access to Top Talent: Connect with qualified candidates who are a perfect fit for your organization.</li>
                <li>Streamlined Hiring Process: Save time and resources with our efficient recruitment strategies and support.</li>
                <li>Improved Candidate Experience: Enhance the candidate journey from application to onboarding, fostering a positive impression of your organization.</li>
                <li>Informed Decision-Making: Utilize data and analytics to optimize your recruitment efforts and improve hiring outcomes.</li>
                <li>Increased Retention Rates: Find candidates who are not only qualified but also committed to contributing to your organization's success.</li>
            </ul>
            
            <p className='font-semibold'>Industries We Serve</p>
            
            <p>Our Recruitment Solutions cater to a wide range of sectors, including technology, healthcare, finance, retail, and manufacturing. We understand the unique requirements and challenges within each industry and adapt our approach to ensure success.</p>
            
            <p className='font-semibold'>Elevate Your Hiring Strategy Today</p>
            
            <p>Finding the right talent can transform your organization. Partner with Junapril Solutions Ltd for comprehensive Recruitment Solutions that empower you to attract and retain top candidates. Contact us today to learn more about how we can support your recruitment needs.</p>
        </div>
    </div>
  )
}
