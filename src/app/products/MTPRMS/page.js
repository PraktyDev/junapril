  ...
  return (
    <div className='flex flex-col mb-40'>
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5 -mt-4'>
                <div>
                    ...
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Detailed risk assessment reports for each vendor</li>
                        <li className='pl-4'>Comprehensive risk categorization to prioritize monitoring efforts</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Continuous risk monitoring with automated alerts for significant changes</li>
                        <li className='pl-4'>Regular updates and insights on vendor performance metrics</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Customized mitigation strategies aligned with your risk tolerance</li>
                        <li className='pl-4'>Implementation support for effective risk management practices</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Compliance assessments tailored to your industry</li>
                        <li className='pl-4'>Guidance on best practices for vendor compliance management</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Customizable reporting tools that provide visibility into vendor risks</li>
                        <li className='pl-4'>Data-driven insights to support strategic vendor management initiatives</li>
                    </ul>
                </div>
            ...
            <p className='-mt-4'>Our Managed Third-Party Risk Management Services cater to a variety of sectors, including finance, healthcare, technology, manufacturing, and government. We understand the unique challenges and regulatory requirements within each industry and customize our solutions accordingly.</p>
            
            <p className='font-semibold'>Partner with Us for Comprehensive Third-Party Risk Management</p>
            
            <p className='-mt-4'>Protect your organization from the complexities and risks associated with third-party relationships. Partner with Junapril Solutions Ltd for Managed Third-Party Risk Management Services that enhance your risk management strategy and safeguard your business. Contact us today to learn more about how we can support your vendor management efforts.</p>
        </div>
    </div>
  )
}
