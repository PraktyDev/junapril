...
const page = () => {
  return (
    <div className='flex flex-col mb-40'>
        <ProductHeader src="bg-[url('/images/head4.png')]"  title='Cloud Readiness Assessment Services' />
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Clear understanding of your business drivers for cloud adoption</li>
                        <li className='pl-4'>Alignment of cloud strategy with your long-term goals</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Inventory of your IT assets and their cloud compatibility</li>
                        <li className='pl-4'>Identification of legacy systems and potential migration challenges</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Application dependency mapping and migration readiness</li>
                        <li className='pl-4'>Recommendations for data storage, backup, and security in the cloud</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Detailed cost analysis, including potential savings</li>
                        <li className='pl-4'>ROI estimation and financial justification for cloud migration</li>
                    </ul> 
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Comparison of cloud service providers</li>
                        <li className='pl-4'>Recommendations tailored to your specific business and technical requirements</li>
                    </ul> 
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Customized cloud migration roadmap</li>
                        <li className='pl-4'>Recommendations for a phased and risk-free implementation</li>
                    </ul> 
                </div>
            </span>
            ...
            <ul className='flex flex-col list-disc list-outside pl-8 -mt-4'>
                <li><span className='font-semibold'>Minimize Migration Risks:</span> Identify and address potential challenges before they become issues during migration.</li>
                <li><span className='font-semibold'>Optimize Costs:</span> Understand the financial impact of cloud migration and how to maximize your return on investment.</li>
                <li><span className='font-semibold'>Enhance Security & Compliance:</span> Ensure your data and applications are protected and compliant with industry standards.</li>
                <li><span className='font-semibold'>Strategic Decision-Making:</span> Make informed choices about your cloud strategy based on a thorough analysis of your IT environment.</li>
            </ul>
            
            <p className='font-semibold'>Ready to Start Your Cloud Journey?</p>
            
            <p className='-mt-4'>Preparing for the cloud is a crucial step toward digital transformation. Let Junapril Solutions Ltd help you assess your readiness and plan a successful migration. Contact us today to schedule your Cloud Readiness Assessment and unlock the full potential of the cloud.</p>
        </div>
    </div>
  )
}
