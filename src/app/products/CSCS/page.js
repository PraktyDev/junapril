  ...
  return (
    <div className='flex flex-col mb-40'>
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Comprehensive security audits and risk assessments</li>
                        <li className='pl-4'>Customized security plans and risk mitigation strategies</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>IAM policies tailored to your organizational needs</li>
                        <li className='pl-4'>Implementation of secure authentication mechanisms</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Data encryption and protection mechanisms</li>
                        <li className='pl-4'>Strategies for secure data backup and disaster recovery</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Real-time threat detection and incident response</li>
                        <li className='pl-4'>Continuous monitoring for vulnerabilities and unusual behavior</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Compliance assessments and gap analysis</li>
                        <li className='pl-4'>Assistance with regulatory documentation and audits</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Secure cloud architecture blueprints</li>
                        <li className='pl-4'>Implementation of zero-trust security models</li>
                    </ul>
                </div>
            ...
            <p className='-mt-4'>Our Cloud Security and Compliance services are designed to meet the needs of various industries, including healthcare, finance, retail, government, and more. We understand the unique challenges and regulations of each sector and tailor our services accordingly.</p>
            
            <p className='font-semibold'>Get Started with Cloud Security and Compliance</p>
            
            <p className='-mt-4'>Don’t let security and compliance concerns slow down your cloud journey. Trust Junapril Solutions Ltd to secure your cloud environment and ensure you meet all regulatory requirements. Contact us today to schedule a consultation and learn how we can protect your business in the cloud.  </p>
        </div>
    </div>
  )
}
