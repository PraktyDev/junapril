...
const page = () => {
  return (
    <div className='flex flex-col mb-40'>
        <ProductHeader src="bg-[url('/images/head9.png')]" title='Remediation Planning and Implementation Services' />
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Comprehensive risk assessment reports</li>
                        <li className='pl-4'>Detailed gap analysis highlighting areas for improvement</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Customized remediation plans with clear objectives</li>
                        <li className='pl-4'>Prioritized action items based on risk levels</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Project management for remediation initiatives</li>
                        <li className='pl-4'>Technical support for deploying security controls and tools</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className='flex flex-col list-disc list-inside'>
                        ...
                        <li className='pl-4'>Regular reports and updates on remediation progress</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold mt-4'>What We Deliver:</p>
                    <ul className='flex flex-col list-disc list-inside'>
                        <li className='pl-4'>Recommendations for ongoing risk management</li>
                        <li className='pl-4'>Frameworks for continuous monitoring and improvement</li>
                    </ul>
                </div>

            </span>

            <div className="py-4"><Image className="w-full h-[500px] rounded-3xl object-cover" src='/images/prod9.png' alt="" width={1000} height={1000} /></div>
            ...
            <p className='-mt-4'>Our Remediation Planning and Implementation services are applicable across various sectors, including healthcare, finance, manufacturing, technology, and government. We understand the unique challenges faced by each industry and tailor our solutions to meet their specific needs.</p>
