...
const page = () => {
  return (
    <div className='flex flex-col'>
        <ProductHeader src="bg-[url('/images/homehero.png')]" title='Health Record Privacy Services' />
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Comprehensive compliance reports highlighting areas for improvement</li>
                        <li className=''>Guidance on aligning policies and practices with regulatory requirements</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Customized privacy policies that reflect best practices and legal requirements</li>
                        <li className=''>Training materials and resources to support policy implementation</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Comprehensive risk assessments to identify potential vulnerabilities</li>
                        <li className=''>Recommendations for implementing security controls and technologies</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Engaging training sessions tailored to different staff roles</li>
                        <li className=''>Ongoing support and resources to reinforce privacy awareness</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Comprehensive incident response plans that outline roles and responsibilities</li>
                        <li className=''>Drills and simulations to prepare your team for real-world scenarios</li>
                    </ul>
                </div>
            ...
            <ul className='flex flex-col space-y-2 list-disc list-inside'>
                <li>Enhanced Patient Trust: Safeguard patient information to build trust and confidence in your organization.</li>
                <li>Regulatory Compliance: Ensure compliance with HIPAA and other regulations, reducing the risk of penalties and legal issues.</li>
                <li>Improved Data Security: Implement robust data protection measures to prevent unauthorized access and breaches.</li>
                <li>Informed Workforce: Equip your employees with the knowledge and skills to protect health information effectively.</li>
                <li>Preparedness for Incidents: Be ready to respond to privacy breaches with effective plans and procedures in place.</li>
            </ul>
            
            <p className='font-semibold'>Industries We Serve</p>
            
            <p>Our Health Record Privacy Services cater to a variety of healthcare organizations, including hospitals, clinics, long-term care facilities, and health technology companies. We understand the unique regulatory and operational challenges faced by each sector and customize our solutions accordingly.</p>
            
            <p className='font-semibold'>Secure Patient Privacy Today</p>
            
            <p>Protecting health records is essential for your organization's success and reputation. Partner with Junapril Solutions Ltd for expert Health Record Privacy Services that ensure compliance, enhance data security, and maintain patient trust. Contact us today to learn more about how we can support your privacy efforts.</p>
        </div>
    </div>
  )
}
