...
const page = () => {
  return (
    <div className='flex flex-col'>
        <ProductHeader src="bg-[url('/images/homehero.png')]" title='Cloud Architecture Design Services' />
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Comprehensive assessment of your business and technology needs</li>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Detailed cloud architecture blueprint</li>
                        <li className=''>Design considerations for scalability, reliability, and performance</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Security architecture that protects against modern threats</li>
                        <li className=''>Compliance strategies for regulations such as GDPR, HIPAA, and more</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Recommendations for cost-saving cloud services</li>
                        <li className=''>Resource management strategies to avoid overspending</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Load balancing, failover mechanisms, and multi-region deployments</li>
                        <li className=''>Disaster recovery plans for data backup and rapid recovery</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Automated deployment scripts and templates</li>
                        <li className=''>Best practices for managing cloud infrastructure as code</li>
                    </ul>
                </div>
            ...
            <ul className='flex flex-col space-y-2 list-disc list-inside'>
                <li>Scalability: Easily scale resources up or down to meet business demands, ensuring performance and efficiency.</li>
                <li>Cost Efficiency: Optimize your cloud spend with cost-effective resource allocation and usage strategies.</li>
                <li>Enhanced Security: Implement robust security measures to protect your data and maintain compliance with regulatory requirements.</li>
                <li>Operational Agility: Quickly adapt to changes and deploy new applications faster, giving your business a competitive edge.</li>
                <li>Reliability & Resilience: Achieve high availability and disaster recovery capabilities to keep your systems running smoothly.</li>
            </ul>

            <p className='font-semibold'>Our Expertise in Cloud Architecture Solutions</p>

            <ul className='flex flex-col space-y-2 list-disc list-inside'>
                <li>Microservices Architecture: Design and implement microservices for greater agility and simplified application management.</li>
                <li>Server less Computing: Take advantage of serverless architectures to improve scalability and reduce infrastructure management overhead.</li>
                <li>Hybrid & Multi-Cloud Strategies: Develop hybrid and multi-cloud solutions to maximize flexibility and avoid vendor lock-in.</li>
                <li>Data Architecture & Analytics: Architect cloud solutions that facilitate advanced data processing and analytics for data-driven decision-making.</li>
            </ul>
            
            <p className='font-semibold'>Ready to Design Your Cloud Future?</p>
            
            <p>Whether you're planning a new cloud deployment or looking to optimize an existing environment, Junapril Solutions Ltd has the expertise to create a cloud architecture that drives innovation and efficiency. Let us help you unlock the full potential of the cloud.</p>
        </div>
    </div>
  )
}
