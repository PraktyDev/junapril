...
const page = () => {
  return (
    <div className='flex flex-col'>
        <ProductHeader src="bg-[url('/images/homehero.png')]" title='IT Audit, Compliance & Regulatory Support Services' />
        ...
        <div className='flex flex-col px-4 gap-4 py-2'>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Detailed assessment of your security infrastructure</li>
                        <li className=''>Recommendations to address vulnerabilities and enhance security</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Compliance gap analysis and risk assessments</li>
                        <li className=''>Support for audit documentation and remediation plans</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Analysis of IT processes and resource utilization</li>
                        <li className=''>Strategies for improving operational efficiency</li>
                    </ul>
                </div>
            </span>
            ...
            <span className='flex flex-col gap-5'>
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Customized compliance frameworks and action plans</li>
                        <li className=''>Ongoing monitoring and updates on regulatory changes</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Well-documented policies and procedures</li>
                        <li className=''>Compliance manuals tailored to your organization's needs</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Interactive training sessions and workshops</li>
                        <li className=''>Awareness programs focused on your specific regulatory environment</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>What We Deliver:</p>
                    <ul className='flex flex-col space-y-2 list-disc list-inside'>
                        <li className=''>Pre-audit assessments and remediation assistance</li>
                        <li className=''>On-site support and coordination with external auditors</li>
                    </ul>
                </div>
            </span>
            ...
            <p>Our IT Audit, Compliance, and Regulatory Support services cater to a variety of sectors, including healthcare, finance, retail, education, government, and more. We understand the unique challenges and regulations in each industry and tailor our services accordingly.</p>

            <p className='font-semibold'>Ready to Strengthen Your IT Governance and Compliance?</p>
            
            <p>Ensure your IT environment is secure, compliant, and well-governed with Junapril Solutions Ltd. Our expert team is here to guide you every step of the way. Contact us today to learn more about how we can support your IT audit, compliance, and regulatory needs.</p>
        </div>
    </div>
  )
}
