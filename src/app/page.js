    ...
    <section className='flex flex-col justify-center gap-4'>
      <div className="relative flex items-center justify-center laptop:justify-end w-full h-screen bg-[url('/images/it.jpg')] bg-no-repeat">
          ...
          <div className='flex flex-col justify-center laptop:items-end laptop:pr-10 items-center gap-14 '> 
            ...
            <p className='laptop:-mt-8 z-10 text-md laptop:text-lg text-center font-semibold text-white'>Your trusted partner in IT security consulting, recruitment, and eCommerce solutions.</p>
            <Link href={''} className='z-10 w-40 laptop:w-56 laptop:-mt-8 text-nowrap text-center bg-none hover:bg-[#277A80] text-white text-md tablet:text-lg laptop:text-xl border-2 px-2 laptop:px-10 py-1.5 laptop:py-2 border-[#277A80] rounded-xl'>Get in Touch</Link>
          </div>
      </div>
