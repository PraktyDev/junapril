...
const ServiceCard = ({ src, title, desc}) => {
  return (
    <Card  className='relative flex flex-col h-auto tablet:h-[420px] bg-[#277A8080] text-white rounded-sm'>
        ...
        <CardFooter className='laptop:absolute laptop:bottom-0 laptop:left-0'>
