...
const ImageCard = ({src, text, alt}) => {
  return (
    <div className="relative w-56 laptop:w-44 h-56 laptop:h-44 overflow-hidden rounded-md group">
      ...
      <p className="absolute bottom-5 left-0 right-0 text-center text-white text-lg laptop:text-md font-bold z-10 bg-[#277A8080] flex justify-center items-center py-1">{text}</p>
    </div>
  )
}
